	...
	<div class="relative bg-white overflow-hidden">
						...
						>
							<div class="flex items-center flex-grow flex-shrink-0 lg:flex-grow-0">
								<div class="flex items-center justify-between w-full md:w-auto">
									<a href="/">
										<span class="sr-only">LOGO HERE I PRAY</span>
										<!--menu icon-->
										<!--<img class="h-8 w-auto sm:h-24" src="https://tailwindui.com/img/logos/workflow-mark-indigo-600.svg">  -->
										<!--svg for logo here-->
							...
							<div class="hidden md:block md:ml-10 md:pr-4 md:space-x-8">
								...
								<a href="#" class="font-medium text-gray-500 hover:text-gray-900">From med and up</a
								>
		...
		<div class="lg:absolute lg:inset-y-0 lg:right-0 lg:w-1/2">
			<img
				...
				src="./static/blessed-be-middle-bass.jpg"
				alt=""
			/>
		</div>
	</div>
